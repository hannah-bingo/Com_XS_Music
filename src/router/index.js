...
const routes = [{
    ...
    path: '/song',
    name: 'songs',
    component: resolve => { require(['@views/songs/index.vue'], resolve) }
}, {
    path: '/singer',
    name: 'singer',
    component: resolve => { require(['@views/singer/index.vue'], resolve) }
}, {
    path: '/album',
    name: 'album',
    ...
    path: '/mvlist',
    name: 'mvlist',
    component: resolve => { require(['@views/mv/index.vue'], resolve) }
}, {
    path: '/mv',
    name: 'mv',
    component: resolve => { require(['@views/mv/detail.vue'], resolve) }
}, {
    path: '/my',
    name: 'my',
    children: [{ path: '/my/favorite', name: 'myFavorite', component: Favorite }, { path: '/my/playlist', name: 'myPlaylist', component: Playlist }],
    component: resolve => { require(['@views/my/index.vue'], resolve) }
}, {
    path: '/artist',
    name: 'artist',
    component: resolve => { require(['@views/artist/index.vue'], resolve) }
}, {
    path: '/search',
    name: 'search',
